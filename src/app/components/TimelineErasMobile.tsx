		...
		<div>
			<div className="flex relative">
				<div className="absolute left-[-2rem] top-[-5px] z-99 w-[80px] h-[50px] flex align-center justify-center bg-[linear-gradient(to_left,rgba(10,10,10,0)_0%,rgba(10,10,10,1)_50%)]">
					...
					>
						<svg width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd" fillRule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" fill="white">
				...
				<div className="absolute right-[-2rem] top-[-5px] z-99 w-[80px] h-[50px] flex align-center justify-center bg-[linear-gradient(to_right,rgba(10,10,10,0)_0%,rgba(10,10,10,1)_50%)]">
					...
					>
						<svg width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" clipRule="evenodd" fillRule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" fill="white">
